...
<?php
    ...
    $sql3 = "SELECT * FROM chaussure WHERE genre = '$genre' AND id != $id ORDER BY RAND() LIMIT 5";
                ...
                <div class="nom_prod">
                    ...
                    <div class ="nb_ar_add_panier">
                        ...
                        <div class="ajout_panier">
                            ...
                            <a  href="../panier/addpanier_co.php?id=<?=$id ?>" class="button_add">Acheter</a>
                        </div>
        ...
        <div class="under_prod">
            <div class="other_prod">
                <?php foreach ($autres_data as $row){
                    echo '
                    <a href="../page_produit/page_produit_co.php?id='.$row['id'].'">
                    <div class="prod">
